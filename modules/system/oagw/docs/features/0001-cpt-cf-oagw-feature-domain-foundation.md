...
**Steps**:
1. [x] - `p1` - Platform operator starts cyberware-server with OAGW module enabled - `inst-boot-1`
...
- [x] ModKit module starts successfully and registers in cyberware-server
