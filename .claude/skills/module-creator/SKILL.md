...
- Module crate: `examples/toolkit/users-info/users-info/src/`
...
| Create module structure, SDK crate, naming, layers | `docs/toolkit_unified_system/02_module_layout_and_sdk_pattern.md` |
| Wire ClientHub, inter-module clients, plugins | `docs/toolkit_unified_system/03_clienthub_and_plugins.md` |
...
| Create out-of-process module, gRPC, OoP SDK | `docs/toolkit_unified_system/09_oop_grpc_sdk_pattern.md` |
...
| Write E2E tests, cross-module integration tests | `docs/toolkit_unified_system/13_e2e_testing.md` |
...
1. Read `docs/toolkit_unified_system/02_module_layout_and_sdk_pattern.md`
2. Read `docs/toolkit_unified_system/10_checklists_and_templates.md` — use the "Adding a New Module" checklist
...
2. Register module in `apps/cf-gears-example-server/src/main.rs`
...
Read the module's current implementation. Compare with `examples/toolkit/users-info/` for the same layer.
