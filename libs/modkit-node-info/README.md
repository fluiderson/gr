...
This library provides system information collection without any transport layer dependencies. It can be used by any Cyber Ware module that needs to gather information about the execution environment.
