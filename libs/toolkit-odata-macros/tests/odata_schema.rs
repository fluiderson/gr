use toolkit_odata::schema::{FieldRef, Schema};
...
// Note: QueryBuilder integration tests moved to toolkit-sdk
...
// Test removed - QueryBuilder functionality belongs in toolkit-sdk tests
...
// Comparison operator tests moved to toolkit-sdk where QueryBuilder lives
