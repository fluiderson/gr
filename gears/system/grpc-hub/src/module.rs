...
mod tests {
    ...
    use toolkit::contracts::Module;
    use toolkit::lifecycle::ReadySignal;
    use toolkit::runtime::{GrpcInstallerData, GrpcInstallerStore, ModuleInstallers};
    use toolkit::{client_hub::ClientHub, config::ConfigProvider, context::ModuleCtx};
    use tower::Service;
    use uuid::Uuid;
    ...
    async fn test_serve_with_system_context() {
        ...
        let module_manager = Arc::new(toolkit::runtime::ModuleManager::new());
