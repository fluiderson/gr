...
The system **MUST** provide an RG module annotated with `#[toolkit::module]` that registers SDK clients in ClientHub and establishes the phased initialization order for circular dependency resolution with AuthZ.
